...
<?php if ( ! $cb_active ) :
	get_template_part( 'template-parts/portal-state', null, array(
		'type'  => 'locked',
		'title' => __( 'Widgets are part of a paid plan', 'chatbotistic' ),
		'lead'  => __( 'Activate a plan to create and manage your AI chatbot widgets.', 'chatbotistic' ),
...
<?php else :
	get_template_part( 'template-parts/portal-state', null, array(
		...
		'lead'  => __( 'The Chatbotistic Connector plugin is required to load your widgets. Please activate it, or contact support.', 'chatbotistic' ),

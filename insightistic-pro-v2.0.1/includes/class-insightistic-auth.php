<?php
/**
 * Shared JWT authentication helper for Insightistic Pro.
...
class Insightistic_Auth {
	...
	public static function get_token( $scope, $cache_key = 'ga4' ) {
		$transient = 'insightistic_pro_access_token_' . $cache_key;
		$cached    = get_transient( $transient );
		if ( $cached ) {
			return $cached;
		}

		$client_email = get_option( 'insightistic_pro_api_email' );
		$enc_key      = get_option( 'insightistic_pro_api_private_key' );

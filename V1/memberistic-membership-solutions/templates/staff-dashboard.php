...
<div class="memberistic-frontend memberistic-staff-dashboard">
	...
	<div class="memberistic-staff-kpis">
		...
		<?php if ( $waiver_enabled ) : ?><div><span><?php esc_html_e( 'Waivers Needed', 'memberistic' ); ?></span><strong><?php echo esc_html( number_format_i18n( $stats['waivers'] ) ); ?></strong></div><?php endif; ?>
	</div>
			...
			<form method="post" class="memberistic-staff-form">
				...
				<label>
					...
					<select name="billing_cycle">
						...
						<option value="lifetime"><?php esc_html_e( 'Lifetime', 'memberistic' ); ?></option>
					</select>
				</label>
				<label>
				...
				<?php else : ?>
					<input type="hidden" name="waiver_status" value="signed">
				<?php endif; ?>
	...
	<div class="memberistic-staff-grid memberistic-staff-grid--bottom">
		<section class="memberistic-staff-panel">
			<h3><?php esc_html_e( 'Recent G2A Bookings', 'memberistic' ); ?></h3>
				...
				<table>
					...
					<tbody>
						...
						<?php if ( empty( $recent_bookings ) ) : ?>
							<tr><td colspan="3"><?php esc_html_e( 'No booking records found from G2A Booking Engine yet.', 'memberistic' ); ?></td></tr>
						<?php endif; ?>
					</tbody>
				</table>
			</div>

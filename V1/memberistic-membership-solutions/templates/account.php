						...
						<div class="memberistic-acct-tablewrap">
							<table class="memberistic-acct-table">
								<thead><tr>
									...
									<?php if ( $waiver_enabled ) : ?><th><?php esc_html_e( 'Waiver', 'memberistic' ); ?></th><?php endif; ?>
									<th><?php esc_html_e( 'Status', 'memberistic' ); ?></th>
								</tr></thead>
								<tbody>
									<?php foreach ( $people as $person ) : ?>
										<tr>
											...
											<?php if ( $waiver_enabled ) : ?><td><span class="memberistic-acct-pill memberistic-acct-pill--<?php echo esc_attr( 'signed' === $person['waiver_status'] ? 'ok' : 'warn' ); ?>"><?php echo esc_html( ucfirst( str_replace( '_', ' ', (string) $person['waiver_status'] ) ) ); ?></span></td><?php endif; ?>

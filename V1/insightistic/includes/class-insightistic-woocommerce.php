<?php
/**
 * WooCommerce Intelligence Pro data layer.
 *
...
class Insightistic_Woocommerce {
	...
	public function ajax_get_data() {
		...
		if ( ! $this->is_active() ) {
			wp_send_json_error( __( 'WooCommerce Intelligence Pro is not active. Enable the addon and install WooCommerce.', 'insightistic' ) );
		}
	...
	/**
	 * True only when both the addon toggle is on AND WooCommerce is loaded.
	 */

...
class Insightistic_System_Status {
	...
	public static function collect() {
		...
		$checks = array(
			...
			self::check( __( 'Frontend tracker under 2.5KB', 'insightistic' ),  self::tracker_under_limit(),                                                                    __( 'Keeps frontend tracking lightweight.', 'insightistic' ),                                 false, null, null ),
	...
	private static function tracker_under_limit() {
		...
		return file_exists( $file ) && filesize( $file ) < 2560;
	}
}

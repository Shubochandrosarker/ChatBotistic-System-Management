...
class Insightistic_Addons {
	...
	/**
	 * Paid WooCommerce intelligence module.
	 *
	 * @return array
	 */
	private static function woocommerce_pro() {
		if ( ! function_exists( 'wc_get_orders' ) ) {
			return array(
				'title' => __( 'WooCommerce Intelligence Pro', 'insightistic' ),
				'intro' => __( 'Premium commerce intelligence activates when WooCommerce is installed.', 'insightistic' ),
				'items' => array(
					array(
						'title'    => __( 'WooCommerce not detected', 'insightistic' ),
						'metric'   => __( 'Paid addon ready, store module inactive', 'insightistic' ),
						'action'   => __( 'Install WooCommerce to unlock revenue, product, and checkout intelligence.', 'insightistic' ),
						'priority' => __( 'Paid', 'insightistic' ),
					),
				),
			);
		}
		...
		return array(
			'title' => __( 'WooCommerce Intelligence Pro', 'insightistic' ),
			'intro' => __( 'Paid commerce intelligence for revenue, orders, and product performance.', 'insightistic' ),
			'items' => $items,
		);
	}
